    ...
    <MainContainer>
      ...
      <Paper className={classes.redBox} variant="outlined">
        <Typography variant="body1">
          <strong>Aviso Importante:</strong> Para todos los usuarios de Elevara CRM que hayan notado una interrupción en el funcionamiento de OpenAI, queremos aclarar que esto no se debe a un error del sistema de Elevara CRM.
El servicio que ofrecemos es una integración que utiliza la Inteligencia Artificial de OpenAI, lo que implica el consumo de tokens a través de la API original de OpenAI. Es importante tener en cuenta que Elevara CRM no se encarga de la gestión de estos tokens, por lo que cada usuario que desee utilizar este servicio debe tener conocimientos sobre cómo utilizar los tokens de OpenAI. Además, para evitar interrupciones en el servicio, recomendamos anclar una tarjeta en débito automático y realizar una autorrecarga mínima de 5 a 10 dólares directamente en la plataforma de OpenAI.
Recuerda que, si tu servicio presenta interrupciones, verifica si los tokens de OpenAI se han agotado y realiza la recarga correspondiente para continuar sin problemas.
Estamos a tu disposición para cualquier duda o aclaración adicional. Agradecemos tu comprensión y seguiremos trabajando para ofrecerte el mejor servicio posible.
        </Typography>
        {/* Links para la configuracion */}
        <Typography variant="body1">
